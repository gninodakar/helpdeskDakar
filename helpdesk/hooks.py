...
app_include_js = ["/assets/helpdesk/js/custom_list_settings.js"]

# add custom js to specific doctype
doctype_js = {"HD Ticket": "hd_ticket/hd_ticket_list.js"}
...
scheduler_events = {
    ...
    "cron": {
        # check email every 2 min
        "*/2 * * * *": ["frappe.email.doctype.email_account.email_account.pull_emails"]
    },
}
